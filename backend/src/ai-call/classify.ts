...
AI콜에 대한 노인 발화를 분석하여 safe / emergency / unclear 세 가지 상태 중 하나로만 답하세요.
- safe: 노인이 현재 안전한 상태
...
## safe 판단 기준
- 본인의 몸상태가 괜찮다고 명확히 표현하는 경우
- 도움이 필요하지 않다고 명확히 표현하는 경우
- 정상적이고 일관된 대화인 경우
- 참고 말뭉치: 괜찮, 괜찮아, 괜찮아요, 괜찮습니다, 별일없어, 별일 없어요, 아무렇지, 아무렇지도 않아, 안아파, 안 아파요, 됐어, 됐어요, 그냥 넘어진 거야, 그냥 넘어졌어, 일어났어, 일어났어요, 놀랐어, 깜짝 놀랐네, 일하고 있어, 일하는 중이야, 쉬고 있어, 잠깐 앉았어
...
- 아래 내용이 하나라도 포함되면 emergency로 판단:
  ...
  - 비정상적 말투
  - 혼란 상태
- 참고 말뭉치: 아파, 아파요, 너무 아파, 넘어졌어, 넘어졌어요, 못 일어나, 못 일어나겠어, 쓰러졌어, 쓰러졌어요, 다쳤어, 다쳤어요, 허리/다리/팔+아파 조합, 어지러워, 어지러워요, 힘들어, 너무 힘들어, 도와줘, 도움, 도움 줘, 구급차, 119, 못 움직여, 움직이질 못해
